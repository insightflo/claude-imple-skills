...
prompt_project_team() {
    ...
    printf "    - 10 specialist agents\n"
    printf "    - 15 auto-validation hooks\n"
    printf "    - 5 maintenance skills\n"
    printf "    - Templates for protocols & contracts\n"
    printf "\n"
    printf "  ${CYAN}Recommended for:${NC} Large projects, team collaboration\n"
...
print_summary() {
    ...
    printf "    /governance-setup - Set up PM → Architect → Designer team\n"
    printf "    /tasks-init       - Generate TASKS.md from scratch\n"
    printf "    /multi-ai-review  - Consensus review (Claude + Gemini + Codex)\n"
    printf "    /orchestrate      - Execute 50-200 tasks with specialist agents\n"
