...
FIXTURE_DIR="$(mktemp -d "$ROOT_DIR/.sisyphus/pass1-fixture.XXXXXX")"
...
(cd "$FIXTURE_DIR" && node "$ROOT_DIR/skills/orchestrate-standalone/scripts/engine/gate-chain.js" pre-dispatch '{"id":"T0.1","title":"fixture"}') 2>&1 | tee "$EVIDENCE_DIR/pass-1-gate.txt"
